...
files. This may result in more deleted code, and Knip may then find more unused
...
### Type members   <Badge text="experimental" variant="caution" />

Unused members of types and interfaces can be removed:
...
Note that [`typeMembers` aren't included by default][1].
