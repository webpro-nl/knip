...
description: Support ongoing Knip development through GitHub Sponsors or OpenCollective, with sponsorship history and teams that rely on Knip.
template: splash
---
...
- The monthly aggregated average over the charted period is $520.
- The monthly recurring average without one-time payments is $362.
