...
tags:
  - Announcement
excerpt: This release is all about replacing the TypeScript backend entirely with oxc-parser and oxc-resolver, and making Knip a whole lot faster!
cover:
  alt: Cover image displaying "6.0" 
  image: ../../../assets/covers/6.png
---
