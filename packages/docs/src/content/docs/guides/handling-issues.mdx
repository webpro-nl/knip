...
Knip may be unable to resolve an import specifier or dependency reference. First
look for solutions such as [paths][25], otherwise they can be ignored as a last
resort:
