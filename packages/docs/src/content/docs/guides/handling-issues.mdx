...
- Knip requires additional configuration, for instance additional [entry
  files][2] or [paths][20] should be added.
- Knip has a bug. You can help your own project and Knip by creating a [minimal
  reproduction][21] and open an issue on GitHub.

Also see [troubleshooting][22] if you haven't already.
...
[21]: ../guides/troubleshooting.md#minimal-reproduction
