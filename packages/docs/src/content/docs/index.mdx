...
- Effective TypeScript: [Recommendation Update: ✂️ Use knip to detect dead code
  and types][25]
- Maddy Miller: [Using Knip to find dead code in a high-traffic git repo][26]
- Josh Goldberg: [Speeding Up Centered Part 4: Unused Code Bloat][27]
- Taro: [Introducing Knip, a tool for removing unnecessary code from
  TypeScript/JavaScript][28] (Japanese)
...
[22]: https://github.com/statelyai/xstate
...
[26]: https://madelinemiller.dev/blog/knip-dead-code/
[27]:
  https://www.joshuakgoldberg.com/blog/speeding-up-centered-part-4-unused-code-bloat/
[28]: https://tech.basemachina.jp/entry/introduction-knip
[29]: https://github.com/mochajs/mocha
