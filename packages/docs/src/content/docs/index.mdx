...
- Taro: [TypeScript/JavaScriptの不要なコードを削除するツール「Knip」の紹介][18]
  (2024-07-25/Japanese 🇯🇵)
- Maddy Miller: [Using Knip to find dead code in a high-traffic git repo][19]
  (2023-09-17)
- Josh Goldberg: [Speeding Up Centered Part 4: Unused Code Bloat][20]
  (2023-08-21)
- Smashing Magazine: [Knip: An Automated Tool For Finding Unused Files, Exports,
  And Dependencies][21] (2023-08-14)
- Effective TypeScript: [Recommendation Update: ✂️ Use knip to detect dead code
  and types][22] (2023-07-29)
...
[19]: https://madelinemiller.dev/blog/knip-dead-code/
[20]: https://www.joshuakgoldberg.com/blog/speeding-up-centered-part-4-unused-code-bloat/
[21]: https://www.smashingmagazine.com/2023/08/knip-automated-tool-find-unused-files-exports-dependencies/
[22]: https://effectivetypescript.com/2023/07/29/knip/
[23]: ./typescript/unused-dependencies.md
