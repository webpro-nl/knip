...
- Mohammed Farmaan: [Declutter Your JavaScript and TypeScript Projects][12]
  (2025-08-13)
- dip Engineer Blog: [Knipで安心してデッドコードを撲滅する][13]
  (2025-04-04/Japanese 🇯🇵)
- Tom MacWright: [Knip: good software for cleaning up TypeScript tech debt][14]
  (2024-10-25)
- Neng Apichet: [มาทำความสะอาด Project โค้ดของเราด้วย Knip กัน][15]
  (2024-10-22/Thai 🇹🇭)
- Anthony Pena: [Knip: l'ultime outil pour faire le ménage dans vos
  projets!][16] (2024-10-08/French 🇫🇷)
- Taro: [TypeScript/JavaScriptの不要なコードを削除するツール「Knip」の紹介][17]
  (2024-07-25/Japanese 🇯🇵)
- Maddy Miller: [Using Knip to find dead code in a high-traffic git repo][18]
  (2023-09-17)
- Josh Goldberg: [Speeding Up Centered Part 4: Unused Code Bloat][19]
  (2023-08-21)
- Smashing Magazine: [Knip: An Automated Tool For Finding Unused Files, Exports,
  And Dependencies][20] (2023-08-14)
- Effective TypeScript: [Recommendation Update: ✂️ Use knip to detect dead code
  and types][21] (2023-07-29)
...
[12]: https://farmaan.dev/writing/using-knip
[13]:
  https://developer.dip-net.co.jp/entry/2025/04/04/Knipで安心してデッドコードを撲滅する
[14]: https://macwright.com/2024/10/25/good-software-knip
[15]:
...
[17]: https://tech.basemachina.jp/entry/introduction-knip
[18]: https://madelinemiller.dev/blog/knip-dead-code/
[19]:
...
[21]: https://effectivetypescript.com/2023/07/29/knip/
[22]: ./typescript/unused-dependencies.md
[23]: ./typescript/unused-exports.md
