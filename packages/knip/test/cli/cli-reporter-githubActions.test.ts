...
test('knip --reporter github-actions (files, unlisted & unresolved)', () => {
  assert.equal(
    ...
    `::error file=src/unused.ts,line=1,endLine=1,col=1,endColumn=1::Unused files: src/unused.ts
::error file=src/index.ts,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: unresolved
::error file=src/index.ts,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: @org/unresolved
...
test('knip --reporter github-actions (rules: unused export, unused dep, unresolved)', () => {
  assert.equal(
    ...
    `::warning file=unused.ts,line=1,endLine=1,col=1,endColumn=1::Unused files: unused.ts
::warning file=package.json,line=1,endLine=1,col=1,endColumn=1::Unused dependencies: unused
::warning file=package.json,line=1,endLine=1,col=1,endColumn=1::Unused devDependencies: @dev/unused
::warning file=package.json,line=1,endLine=1,col=1,endColumn=1::Referenced optional peerDependencies: optional-peer-dep
::warning file=index.ts,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: unlisted
::warning file=package.json,line=1,endLine=1,col=1,endColumn=1::Unlisted binaries: unlisted
...
::warning file=exports.ts,line=1,endLine=1,col=1,endColumn=1::Duplicate exports: used|default`
  );
});
...
test('knip --reporter github-actions (workspaces: unused export, unused dep, unlisted dep)', () => {
  assert.equal(
    ...
    `::error file=docs/dangling.ts,line=1,endLine=1,col=1,endColumn=1::Unused files: docs/dangling.ts
...
::error file=packages/tools/tsconfig.json,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: @fixtures/workspaces__tsconfig
::error file=apps/frontend/index.ts,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: vanilla-js
::error file=apps/backend/index.ts,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: js-yaml
::error file=apps/backend/index.ts,line=1,endLine=1,col=1,endColumn=1::Unlisted dependencies: globby
