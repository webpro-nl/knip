...
export const getVueAutoImportMaps = (cwd: string): AutoImportMaps => {
...
export const getSyntheticImports = (maps: AutoImportMaps, identifiers: Set<string>, templateTags?: Set<string>) => {
