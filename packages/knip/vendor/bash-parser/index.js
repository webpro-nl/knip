...
var xi = x((Rp, mi) => {
  ...
  mi.exports = function (e, r) {
    ...
    return {
      nextReduction: e.previousReducer,
      nextState: e.appendChar(s).replaceLastExpansion({
        parameter: s,
    ...
    return i === '(' && e.current.slice(-2) === '$('
      ...
      : i === void 0
        ...
        : i === ')'
          ? {
              nextReduction: e.previousReducer,
              nextState: e.appendChar(i).replaceLastExpansion({
...
var on = x(Zt => {
  ...
  a.braceL.updateContext = function (t) {
    (this.state.context.push(this.braceIsBlock(t) ? L.braceStatement : L.braceExpression),
      (this.state.exprAllowed = !0));
  };
...
`,
        ...
        (t.prototype.readNumber = function (r) {
          var s = this.state.pos,
            ...
            n = !1;
          (!r && this.readInt(10) === null && this.raise(s, 'Invalid number'),
            i && this.state.pos == s + 1 && (i = !1));
          var o = this.input.charCodeAt(this.state.pos);
          (o === 46 &&
            !i &&
            (++this.state.pos, this.readInt(10), (n = !0), (o = this.input.charCodeAt(this.state.pos))),
            (o === 69 || o === 101) &&
              !i &&
...
`
  ...
  P.flowParseTypeAnnotatableIdentifier = function () {
    ...
    return (
      this.match(a.colon) && ((t.typeAnnotation = this.flowParseTypeAnnotation()), this.finishNode(t, t.type)), t
    );
  };
